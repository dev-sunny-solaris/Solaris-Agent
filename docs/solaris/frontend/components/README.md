...
Coverage is intentionally incremental. Fieldset and specialized dashboard/domain Components require
dedicated guides before agents treat them as documented contracts.
